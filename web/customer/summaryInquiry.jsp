...
<html>
    ...
    <body>
        <div class="header">
            ...
            <a href="currentinquiry.jsp"><p class="backBtn"><img src = "../img/back.png" width="30px">&nbsp Return</p></a>
        		...
        		<div class="card-body height3">
                      ...
                      //  int A_ID= Integer.parseInt(session.getAttribute("A_ID").toString());
                        ...
                        try {
                            ...
                            //prepared statement
                            String sqlselect = "select * from inquiry where inquiryID = '"+inqID+"'";
                            ...
                            String sqlselect2 = "select * from reply where inquiryID = '"+inqID+"'";
